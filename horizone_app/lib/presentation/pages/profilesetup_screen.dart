            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  OrangeTextForm(nameButton: S.of(context).name, icon: Icons.person, controller: formProvider.nameController, validator: formProvider.validateName,),
                  ...
                  const SizedBox(height: 18),
                  OrangeTextForm(nameButton: S.of(context).gender, icon: Icons.person_outline, controller: formProvider.genderController, validator: formProvider.validateGender,),
                  const SizedBox(height: 18),
                  OrangeTextForm(nameButton: S.of(context).jobTitle, icon: Icons.work_outline, controller: formProvider.jobTitleController, validator: formProvider.validateJobTitle,),
                ],
              ),
            ),
          ),
